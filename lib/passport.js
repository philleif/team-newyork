        ...
        process.nextTick(function() {
          User.findOne({ email: email }, async (err, user) => {
            ...
            if (user) {
              ...
              newUser.tokens.letter = newUser.generateHash(
                Math.floor(Math.random() * 900000 + 100000)
              )
              newUser.tokens.passwordReset = newUser.generateHash(
                Math.floor(Math.random() * 900000 + 100000)
              )
              newUser.email = email
              ...
              newUser.phone.verifyCode = Math.floor(Math.random() * 900000 + 100000)
